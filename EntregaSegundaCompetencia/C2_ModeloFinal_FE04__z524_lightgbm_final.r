...
PARAM <- list()
PARAM$experimento <- "C2_ModeloFinal_FE04"
...
PARAM$finalmodel$num_iterations <- 2783
PARAM$finalmodel$learning_rate <- 0.0386552368615766
PARAM$finalmodel$feature_fraction <- 0.218350432655943
PARAM$finalmodel$min_data_in_leaf <- 304
PARAM$finalmodel$num_leaves <- 1006
