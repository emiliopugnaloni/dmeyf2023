...
PARAM$experimento <- "C2_BayesianOpt_FE04"
...
PARAM$hyperparametertuning$semilla_azar <- 673789
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_data_in_leaf", lower = 40L, upper = 8000L),
  makeIntegerParam("num_leaves", lower = 100L, upper = 1024L),
  makeIntegerParam("envios", lower = 7000L, upper = 18000L)
)
