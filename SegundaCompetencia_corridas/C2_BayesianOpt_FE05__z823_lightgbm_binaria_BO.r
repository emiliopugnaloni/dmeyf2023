...
PARAM$experimento <- "C2_BayesianOpt_FE05"
...
PARAM$input$training <- c(201907, 201908, 201909, 201910, 201911, 201912, 202011, 202012, 202101, 202102, 202103)

# un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$undersampling <- 0.6
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.008, upper = 0.3),
  makeNumericParam("feature_fraction", lower = 0.2, upper = 0.5),
  makeIntegerParam("num_leaves", lower = 80L, upper = 1024L),
  makeIntegerParam("min_data_in_leaf", lower = 50L, upper = 10000L)
)
