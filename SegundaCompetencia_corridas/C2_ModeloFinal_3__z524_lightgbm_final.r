...
PARAM <- list()
PARAM$experimento <- "C_ModeloFinal_3"
...
PARAM$finalmodel$num_iterations <- 7744
PARAM$finalmodel$learning_rate <- 0.0101458710080036
PARAM$finalmodel$feature_fraction <- 0.348827798154119
PARAM$finalmodel$min_data_in_leaf <- 175
PARAM$finalmodel$num_leaves <- 425
