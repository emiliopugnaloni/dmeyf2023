...
PARAM$experimento <- "C2_BayesianOpt_FE12_ii"

PARAM$input$dataset <- "./datasets/competencia_02_fe12.csv.gz"

# los meses en los que vamos a entrenar
#  mucha magia emerger de esta eleccion
PARAM$input$testing <- c(202105)
PARAM$input$validation <- c(202104)
PARAM$input$training <- c(201909, 201910, 201911,201912,202010, 202011, 202012, 202101, 202102, 202103)
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.2, upper = 0.7),
  makeIntegerParam("num_leaves", lower = 70L, upper = 2024L),
  makeIntegerParam("min_data_in_leaf", lower = 50L, upper = 15000L)
)
